 ...
 */
seajs.use(['jquery','baidu-map','jquery-browser','qqface','layer','template','test'],function($,baidu_map,jquery_browser,qqface,layer,template,test){
    var postAdd = {
        init: function(){
            jquery_browser($);
            qqface($);
        ...
        bindEvent: function(){
            ...
            $('.emotion').qqFace({
                id : 'facebox',
                assign:'content',
                path:'/seajs/qqface/arclist/' //表情存放的路径
            });
            ...
            function replace_em(str){
                ...
                str = str.replace(/\>/g,'&gt;');
                str = str.replace(/\n/g,'<br/>');
                str = str.replace(/\[em_([0-9]*)\]/g,'<img src="/seajs/qqface/arclist/$1.gif" border="0" />');
                return str;
            }
        }
    };
